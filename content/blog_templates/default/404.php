...
<head>
    ...
    <title>页面未找到 - <?= htmlspecialchars($blogSiteName, ENT_QUOTES) ?></title>
...
<body class="blog-special-page">
    <main class="blog-special-wrap">
        <section class="blog-special-card" role="alert">
            ...
            <div class="blog-special-icon"><i class="ri-compass-3-line"></i></div>
            <div class="blog-special-code">404</div>
            <h1 class="blog-special-title">这个页面好像走丢了</h1>
            <p class="blog-special-desc">你访问的链接可能已失效、被移动，或地址输入有误。可以返回博客首页继续浏览文章。</p>
            <div class="blog-special-actions">
                <a class="blog-special-btn primary" href="<?= htmlspecialchars($blogHomeUrl, ENT_QUOTES) ?>"><i class="ri-home-5-line"></i>返回博客首页</a>
                <a class="blog-special-btn ghost" href="<?= DC_URL ?>"><i class="ri-store-2-line"></i>网站首页</a>
