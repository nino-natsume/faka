...
<head>
    ...
    <link rel="stylesheet" href="<?= DC_URL ?>admin/views/css/bootstrap.min.css">
...
<div class="payment-container">
    <img src="<?= DC_URL ?>content/plugins/alipay/zhifubao.jpeg" alt="支付宝" class="logo">
...
<script src="<?= DC_URL ?>content/plugins/alipay/qrcode.min.js?t=<?= Option::DC_VERSION_TIMESTAMP ?>"></script>
...
<script>
    ...
    function checkPay(){
        $.ajax({
            url: "?action=alipay_check_pay",
            type: "POST",
            data: { out_trade_no: out_trade_no },
            dataType: "json",
            success: function(e) {
                if(e.code == 200 && e.data.is_pay){
