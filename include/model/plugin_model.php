...
class Plugin_Model {
    ...
    function getPlugins($filter = '') {
        ...
        $emPlugins = [];
        $pluginFiles = [];
        $pluginPath = DC_ROOT . '/content/plugins';
                ...
                if ($pluginsSubDir) {
                    while (($subFile = $pluginsSubDir->read()) !== false) {
                        ...
                        if ($subFile == $file . '.php') {
                            ...
                            $previewPath = PLUGIN_PATH . $file . '/preview.jpg';
                            $previewUrl = file_exists($previewPath) 
                                ? PLUGIN_URL . $file . '/preview.jpg?v=' . filemtime($previewPath) 
                                : './views/images/plugin-icon.png';
                            $pluginFiles[] = [
                                'file'          => $file . '/' . $subFile,
