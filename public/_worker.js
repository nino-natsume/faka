// DCSHOP faka - Pages 单文件入口 (由 worker.js+admin.js+lib.js 打包生成, 勿手改)

// D:/Desktop/faka/lib.js
function esc(s) {
...
async function pageHome(request, env, q, isSearch) {
  ...
  return new Response(layout(env, { ...opts, title: kw ? "\u641C\u7D22 - " + kw : opt(opts, "site_title", "DCSHOP\u53D1\u5361\u7CFB\u7EDF") }, navItems, body), HTML_HEADERS2);
}
...
async function pageGoods(request, env, q) {
  ...
  return new Response(layout(env, { ...opts, title: g.title }, navItems, body), HTML_HEADERS2);
}
...
async function pagePay(request, env, q) {
  ...
  return new Response(layout(env, { ...opts, title: "\u8BA2\u5355\u652F\u4ED8" }, navItems, body), HTML_HEADERS2);
}
...
async function pageOrderResult(request, env, q) {
  ...
  return new Response(layout(env, { ...opts, title: "\u8BA2\u5355\u7ED3\u679C" }, navItems, body), HTML_HEADERS2);
}
...
async function pageOrderQuery(request, env, q) {
  ...
  return new Response(layout(env, { ...opts, title: "\u8BA2\u5355\u67E5\u8BE2" }, navItems, body), HTML_HEADERS2);
}
...
async function pageHelp(request, env, q) {
  ...
  return new Response(layout(env, { ...opts, title: "\u4E70\u5BB6\u5E2E\u52A9" }, navItems, body), HTML_HEADERS2);
}
async function pageUser(request, env, q) {
  ...
  return new Response(layout(env, { ...opts, title: "\u4F1A\u5458\u4E2D\u5FC3" }, navItems, body), HTML_HEADERS2);
}
