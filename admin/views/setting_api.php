...
<div class="panel-heading">
    <ul class="nav nav-pills">
        <li class="nav-item"><a class="nav-link" href="./setting.php">系统配置</a></li>
        <li class="nav-item"><a class="nav-link" href="./setting.php?action=user">用户配置</a></li>
...
<div class="card shadow mb-4 mt-2">
    <div class="card-body">
        ...
        <div class="alert alert-warning">
            <b>API接口列表：</b><br><br>
            1. 文章发布 (可用于对接内容发布软件，文章发布接口URL：<?= DC_URL ?>?rest-api=article_post)<br>
            2. 分类列表<br>
            3. 微语发布<br>
            4. 微语列表<br>
            5. 资源文件上传<br>
            ……<br><br>
            详见接口文档：<a href="https://dcshop.xzsc.cc" target="_blank">API接口文档→</a>
        </div>
    </div>
</div>
<script>
