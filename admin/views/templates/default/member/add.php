    ...
    <div style="padding: 25px;" id="open-box">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="text" name="name" class="layui-input" value="" placeholder="例如：普通用户、银牌会员、金牌代理" lay-verify="required">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <div class="ml-icon-picker">
                    ...
                    <button type="button" class="ml-icon-choice<?= $_icon === 'ri-vip-diamond-line' ? ' is-active' : '' ?>" data-icon="<?= $_icon ?>"><i class="<?= $_icon ?>"></i></button>
                    <?php endforeach; ?>
                </div>
                <input type="text" name="icon" id="ml-icon" class="layui-input" value="ri-vip-diamond-line" placeholder="例如：ri-vip-diamond-line">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <div class="ml-icon-image-row">
                    <input type="text" name="icon_image" id="ml-icon-image" class="layui-input" value="" placeholder="上传后自动填入图片地址">
                ...
                <div class="ml-icon-preview" id="ml-icon-preview"><i class="ri-vip-diamond-line"></i></div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="price" class="layui-input" value="0" min="0" step="0.01" placeholder="0.00">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="markup_ratio" class="layui-input" value="0" min="0" step="0.01" placeholder="0">
            ...
            <div class="layui-input-block">
                ...
                <select name="profit_rule_id">
                    ...
                    <?php foreach (($profitRules ?? []) as $r): ?>
                        <option value="<?= (int)$r['id'] ?>"><?= htmlspecialchars($r['name']) ?> (#<?= (int)$r['id'] ?>)</option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="exchange_ratio" class="layui-input" value="0" min="0" step="0.01" placeholder="0">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="actual_profit" class="layui-input" value="0" min="0" max="100" step="0.01" placeholder="0">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="profit_threshold" class="layui-input" value="0" min="0" max="100" step="0.01" placeholder="0">
                <span class="form-tips">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="duration_days" class="layui-input" value="0" min="0" step="1" placeholder="0">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="renew_ratio" class="layui-input" value="0" min="0" max="100" step="0.01" placeholder="0">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="upgrade_direct_count" class="layui-input" value="0" min="0" step="1" placeholder="0">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="upgrade_consume_amount" class="layui-input" value="0" min="0" step="0.01" placeholder="0.00">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="upgrade_team_count" class="layui-input" value="0" min="0" step="1" placeholder="0">
        ...
        <input type="hidden" name="state" id="ml-state" value="1">
        <div class="layui-form-item">
            <label class="layui-form-label">等级说明</label>
            <div class="layui-input-block">
                <div class="ml-field-tag">给用户看的介绍</div>
                <textarea name="content" class="layui-textarea" placeholder="例如：开通后享受全站最低价，适合长期批发的用户"></textarea>
        ...
        <div id="form-btn">
            <div class="layui-input-block">
            <button type="submit" class="layui-btn" lay-submit lay-filter="submit">创建等级</button>
