    ...
    <div style="padding: 25px;" id="open-box">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sortname" class="layui-input" value="">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">别名</label>
            <div class="layui-input-block">
                <input type="text" name="alias" class="layui-input" value="">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select class="layui-input" name="pid">
                    ...
                    <?php
                    $renderSortOptions = function ($pid = 0, $level = 0) use (&$renderSortOptions, $sorts) {
                        foreach ($sorts as $key => $val) {
                            if ((int)$val['pid'] !== (int)$pid) {
                                continue;
                            }
                            echo '<option value="' . (int)$key . '">' . str_repeat('&nbsp;&nbsp;&nbsp;', $level) . ($level > 0 ? '└ ' : '') . $val['sortname'] . '</option>';
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="layui-input-group" style="width: 100%; display: flex;">
                    <input type="text" placeholder="分类图片" class="layui-input" name="sortimg" id="sortimg">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="layui-input-group" style="width: 100%; display: flex; align-items: center; gap: 10px;">
                    <input type="text" value="" placeholder="Remix Icon 类名，如：ri-apps-line" class="layui-input" name="sorticon" id="sorticon" style="flex: 1;">
                    <div id="icon-preview" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; border: 1px solid #eee; border-radius: 4px; background: #f8f9fa;">
                        <i class="ri-apps-line" style="font-size: 24px; color: #333;"></i>
                    </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="taxis" class="layui-input" value="">
            </div>
        </div>
        <?php if ($type === 'blog'): ?>
        <div class="layui-form-item">
                ...
                <select name="template">
                    ...
                    <?php if (!empty($customTemplates)): ?>
                        <?php foreach ($customTemplates as $tpl): ?>
                            <option value="<?= $tpl['filename'] ?>"><?= $tpl['comment'] ?></option>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </select>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" min="0" name="page_count" class="layui-input" value="0" placeholder="0 表示使用博客全局每页数量">
            </div>
        </div>
        <?php endif; ?>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea class="layui-textarea" name="kw"></textarea>
            </div>
        </div>
