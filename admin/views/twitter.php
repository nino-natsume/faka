...
<link rel="stylesheet" type="text/css" href="./views/css/markdown.css?t=<?= Option::DC_VERSION_TIMESTAMP ?>">
<script src="./editor.md/editormd.js?t=<?= Option::DC_VERSION_TIMESTAMP ?>"></script>
<script>
