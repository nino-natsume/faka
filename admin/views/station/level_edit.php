<?php defined('DC_ROOT') || exit('access denied!'); $stationIcon = !empty($info['icon']) ? $info['icon'] : 'ri-store-2-line'; $stationIconImage = !empty($info['icon_image']) ? $info['icon_image'] : ''; ?>
<style>
    ...
    <div style="padding: 25px;" id="open-box">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="text" name="name" class="layui-input" value="<?= htmlspecialchars($info['name']) ?>" placeholder="例如：基础分店、高级分店、旗舰版" lay-verify="required">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <div class="sl-icon-picker">
                    ...
                    <button type="button" class="sl-icon-choice<?= $_icon === $stationIcon ? ' is-active' : '' ?>" data-icon="<?= $_icon ?>"><i class="<?= $_icon ?>"></i></button>
                    <?php endforeach; ?>
                </div>
                <input type="text" name="icon" id="sl-icon" class="layui-input" value="<?= htmlspecialchars($stationIcon) ?>" placeholder="例如：ri-store-2-line">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <div class="sl-icon-image-row">
                    <input type="text" name="icon_image" id="sl-icon-image" class="layui-input" value="<?= htmlspecialchars($stationIconImage) ?>" placeholder="上传后自动填入图片地址">
                ...
                <div class="sl-icon-preview" id="sl-icon-preview"><?= $stationIconImage ? '<img src="' . htmlspecialchars($stationIconImage) . '" alt="">' : '<i class="' . htmlspecialchars($stationIcon) . '"></i>' ?></div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="number" name="sort" class="layui-input" value="<?= intval($info['sort'] ?? 0) ?>" min="0" step="1">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <?php $currentGate = intval($info['member_gate'] ?? 0); ?>
                <select name="member_gate">
                    <option value="0" <?= $currentGate === 0 ? 'selected' : '' ?>>不限制（任何人都能开）</option>
                    <?php foreach ($memberLevels as $lv): if ((int)($lv['state'] ?? 1) !== 1) continue; ?>
                    <option value="<?= (int)$lv['id'] ?>" <?= $currentGate === (int)$lv['id'] ? 'selected' : '' ?>><?= htmlspecialchars($lv['name']) ?></option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="sl-perm-grid">
            ...
            foreach ($permList as $field => $meta):
                $checked = ($info[$field] ?? 'n') === 'y' ? 'checked' : '';
            ?>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="checkbox" name="<?= $field ?>" value="y" lay-skin="switch" lay-text="开|关" <?= $checked ?>>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="text" name="service_change" class="layui-input" value="<?= $info['service_change'] ?>" placeholder="0">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <?php $curMode = $info['upgrade_mode'] ?? 'any'; ?>
                <select name="upgrade_mode">
                    <option value="any" <?= $curMode === 'any' ? 'selected' : '' ?>>满足任一条件即可升级（OR）</option>
                    <option value="all" <?= $curMode === 'all' ? 'selected' : '' ?>>必须全部满足才能升级（AND）</option>
                </select>
                <span class="form-tips">
        ...
        <div class="sl-perm-grid">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="number" name="upgrade_sales_amount" class="layui-input" value="<?= (float)($info['upgrade_sales_amount'] ?? 0) ?>" step="0.01" min="0" placeholder="0">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="number" name="upgrade_order_count" class="layui-input" value="<?= (int)($info['upgrade_order_count'] ?? 0) ?>" min="0" placeholder="0">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="number" name="upgrade_days" class="layui-input" value="<?= (int)($info['upgrade_days'] ?? 0) ?>" min="0" placeholder="0">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="number" name="upgrade_sub_count" class="layui-input" value="<?= (int)($info['upgrade_sub_count'] ?? 0) ?>" min="0" placeholder="0">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <textarea name="description" class="layui-textarea" placeholder="例如：免费开通，基础功能；或：解锁独立域名与自定义价格，低手续费"><?= htmlspecialchars($info['description'] ?? '') ?></textarea>
